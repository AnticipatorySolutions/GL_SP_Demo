...
namespace GL_SP_Demo_API.Controllers
{
    ...
    public class RouteController : ControllerBase
    {
        ...
        public RouteController(IGL_Route_BLL sP_Route_BLL)
        {
            _SP_Route_BLL = sP_Route_BLL;
        }

        // Finds the Route Using A Look Up
        ...
        // EXAMPLE: of 2 Step Trek: api/Route/SP?src=YYZ&dst=LAX
        // EXAMPLE: of 12 Step Trek: api/Route/SP?src=ASF&dst=MAJ
            ...
            [FromQuery] string dst)
        {
            try
            {
                ...
                return _SP_Route_BLL.GetShortestRoute(src, dst);
            }
